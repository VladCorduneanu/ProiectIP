...
-Lista tools:   
		-Skype :call-uri, videoconferinta si desktop sharing
...
Idei Implementare:
	...
	-Logica jocului: Specifiicatiile:
					- exista un timer pt fiecare intrebare
...
Stil interfata:
	Window:
		-> Size: 1080x640
	Labels:
		Login   -> ForeColor: White
			-> BackColor: Transparent
			-> Font -> Size: 20

	Buttons: 
		Login   -> ForeColor: ControlLightLight
			-> BackColor: ControlDarkDark
			-> Font -> Size: 15
			-> Appearance -> FlatAppearance -> FlatStyle: Popup
			-> Appearance -> BackgroundImageLayout: None